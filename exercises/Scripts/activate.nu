...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\liord\OneDrive\mego\python\exercises'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\liord\OneDrive\mego\python\exercises\Scripts\deactivate.nu'
